...
export function Blogs() {
  const articles = [
    ...
    },
    {
      ...
      desc: "Inflation is eating into your savings. Learn how systematic investment plans can help you beat it in the long run.",
      date: "Jul 15, 2026",
      category: "Investing",
    },
    {
      title: "Home loan interest rates expected to drop",
      desc: "With the central bank hinting at rate cuts, here is what prospective homebuyers need to know before taking a loan.",
      date: "Jul 10, 2026",
      category: "Loans",
    },
  ];
