...
const ARTICLES = [
  {
    ...
    desc: "A comprehensive guide to the latest changes in the tax slabs and how they affect your take-home salary.",
    date: "Jul 18, 2026",
    category: "Tax Planning",
  },
  {
    title: "Why SIPs are still your best bet against inflation",
    desc: "Inflation is eating into your savings. Learn how systematic investment plans help you beat it.",
    date: "Jul 15, 2026",
    category: "Investing",
  },
  {
    title: "Home loan interest rates expected to drop",
    desc: "With the central bank hinting at rate cuts, here is what prospective homebuyers need to know.",
    date: "Jul 10, 2026",
    category: "Loans",
  },
  {
    title: "How much should you keep in an emergency fund?",
    desc: "A simple framework to size your safety net based on income stability and monthly expenses.",
    date: "Jul 04, 2026",
    category: "Savings",
  },
  {
    title: "FD vs RD: which one fits your goal?",
    desc: "Compare lump-sum and recurring deposits on returns, liquidity and discipline before you commit.",
    date: "Jun 28, 2026",
    category: "Deposits",
  },
];
