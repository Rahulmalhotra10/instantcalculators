...
const DEFAULT_GLOW_COLOR = "132, 255, 100"; // light greenish glow
...
const GlobalSpotlight = ({
  ...
  useEffect(() => {
    ...
    const handleMouseLeave = () => {
      ...
      gridRef.current?.querySelectorAll(".magic-bento-card").forEach((card: unknown) => {
        (card as HTMLElement).style.setProperty("--glow-intensity", "0");
      });
...
export const MagicBentoContainer = ({
  children,
  className = "",
